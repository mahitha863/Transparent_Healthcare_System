...
import userinterface.THCSDataCollectorRole.HealthCostsDirectoryJPanel;
...
public class DataAnalyserWorkAreaJPanel extends javax.swing.JPanel {
     ...
     */
    public DataAnalyserWorkAreaJPanel(JPanel userProcessContainer, UserAccount account, Organization organization, EcoSystem business, Enterprise enterprise, Network network) {
        initComponents();
        ...
        for (WorkRequest request : daOrganization.getWorkQueue().getWorkRequestList()) {
            if (request.getStatus().equals("DA phase - TBA") || request.getStatus().equals("DA phase - WIP")) {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Data Analyser Work Area");
        ...
        ReportDataToManagerJButton.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ReportDataToManagerJButtonActionPerformed(evt);
            }
        });
    ...
    private void assignJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_assignJButtonActionPerformed
        ...
        for (WorkRequest r : daOrganization.getWorkQueue().getWorkRequestList()) {
    ...
    private void AnalysisDashboardJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AnalysisDashboardJButtonActionPerformed
        ...
        if(assigned_to_me){
            DataAnalysisDashboardJPanel dataAnalysisDashboardJPanel = new DataAnalysisDashboardJPanel(userProcessContainer, userAccount, daOrganization, business, thcsEnterprise, network);
            userProcessContainer.add("dataAnalysisDashboardJPanel", dataAnalysisDashboardJPanel);
            CardLayout layout = (CardLayout) userProcessContainer.getLayout();
            layout.next(userProcessContainer);
        }
        else{
            JOptionPane.showMessageDialog(null, "Please assign a request to yourself before analysing the data");
        }
        
    }//GEN-LAST:event_AnalysisDashboardJButtonActionPerformed

    private void ReportDataToManagerJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ReportDataToManagerJButtonActionPerformed
        ...
        //If req is DA phase - WIP, req can be marked completed and transferred to manager 
        //WorkRequest request = (WorkRequest)workRequestJTable.getValueAt(selectedRow, 0);
        ...
        if(request.getStatus().equals("DA phase - WIP")){
            request.setStatus("Completed");
                    populateWorkQueueTable();
        populateHistoryTable();
        }else{
            JOptionPane.showMessageDialog(null, "Request not processed by Data Analyser");
            return;
        }
    }//GEN-LAST:event_ReportDataToManagerJButtonActionPerformed
