...
public class ManageEnterpriseAdminJPanel extends javax.swing.JPanel {
    ...
    private void submitJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitJButtonActionPerformed
        ...
        UserAccount account = new UserAccount();
                //enterprise.getUserAccountDirectory().createUserAccount(username, password, employee, new THCSAdminRole());
        
        
        if (null != enterprise.getEnterpriseType()) {
            switch (enterprise.getEnterpriseType()) {
                case THCS:
                    account = enterprise.getUserAccountDirectory().createUserAccount(username, password, employee, new THCSAdminRole());
                    break;
                case Hospital:
